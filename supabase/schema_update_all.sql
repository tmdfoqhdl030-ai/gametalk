-- ====================================================================
-- 🛠️ 게임스피킹 운영 및 게임 등급제 테이블/컬럼 일괄 생성 스크립트
-- 이 전체 코드를 복사하여 Supabase Dashboard > SQL Editor에 실행해주세요!
-- ====================================================================
...
-- 신고 RLS 정책
DROP POLICY IF EXISTS "Reports are viewable by admins and reporter" ON public.reports;
...
-- 6. english_level 등급 제약 조건 제거 및 Iron ~ Challenger 등급 확장 적용
