...
const NOTICES: Notice[] = [
  {
    ...
    title: "🎉 게임스피크 정식 서비스 오픈!",
    date: "2026.05.01",
    content: `안녕하세요, 게임스피크 팀입니다!

오늘부터 게임스피크이 정식 서비스를 시작합니다. 🎮

게임스피크은 한국 게이머들이 영어로 소통하는 팀원을 쉽게 찾을 수 있는 플랫폼입니다. 배틀그라운드, 리그오브레전드, 오버워치, 발로란트, 롤토체스 — 내가 즐기는 게임에서 영어로 대화할 팀원을 지금 바로 찾아보세요.
...
앞으로 더 많은 기능과 이벤트로 찾아오겠습니다. 많은 이용 부탁드립니다. 감사합니다! 🙏`,
  },
  {
    ...
    date: "2026.05.01",
    content: `게임스피크을 즐겁고 건전하게 이용하기 위한 규칙을 안내드립니다.
...
• 로그아웃 후 새로고침 시 오류 수정`,
  },
  {
    ...
    date: "2026.05.15",
    content: `이제 게임스피크에서 방을 만들면 디스코드 음성채널이 자동으로 생성됩니다!

🔗 작동 방식
1. 웹에서 "방 만들기" 클릭
2. 게임스피크 봇이 디스코드 서버에 전용 음성채널 자동 생성
...
기존에 Discord 링크를 직접 입력해야 했던 불편함이 해소됩니다. 더 빠르고 편하게 팀원을 모아 게임을 시작하세요! 🚀`,
  },
  {
    ...
    date: "2026.05.10",
    content: `게임스피크에 매너 온도 시스템이 도입됩니다.
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-400 mt-1">게임스피크의 주요 공지 및 업데이트 내역을 확인하세요.</p>
      </div>
