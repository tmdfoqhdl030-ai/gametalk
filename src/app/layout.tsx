...
export const metadata: Metadata = {
  ...
  title: {
    default: "게임스피크 — 게임하면서 영어 실력 UP",
    template: "%s — 게임스피크",
  },
  description: "배틀그라운드, 롤, 오버워치, 발로란트에서 영어로 소통하는 팀원을 찾아보세요. 게임하면서 자연스럽게 영어 실력이 올라갑니다.",
  keywords: ["게임 영어", "팀원 모집", "배틀그라운드 영어", "롤 영어", "오버워치 영어", "발로란트 영어", "영어 게이머", "게임스피크"],
  authors: [{ name: "게임스피크" }],
  creator: "게임스피크",
  openGraph: {
    type: "website",
  ...
  verification: {
    ...
    other: {
      "naver-site-verification": "1cef263e07dbd30dfb306112547be987835bd2be",
    },
  },
};
